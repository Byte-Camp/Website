    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="login-section container content-section text-center col-xs-10 col-sm-9 col-md-6 col-lg-3 col-centered" data-aos="fade-right" data-aos-duration="500" data-aos-once="true">
            <form action="../connect/login.php" method='post'>
                ...
                <br>
                <button type="submit" class="login-input btn btn-primary" id="submit-login" name="submit-login" style="margin-top:10px;">Login</button>
                <br>
                <button type="button" class="login-input btn btn-info" style="margin-top:5px;" onclick="alert('Please email adar@bytecamp.ca with all questions.');">Trouble Logging In?</button>
            </form> 
        </div>
        <!-- Google Maps API -->
