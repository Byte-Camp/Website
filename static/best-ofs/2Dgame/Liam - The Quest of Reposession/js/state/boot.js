"use strict";
window.TheQuestofReposession.state.boot = {
	preload: function(){
		// set world size
	...
	create: function(){
		// add all game states
		for(var stateName in window.TheQuestofReposession.state){
			this.game.state.add(stateName, window.TheQuestofReposession.state[stateName]);
		}
