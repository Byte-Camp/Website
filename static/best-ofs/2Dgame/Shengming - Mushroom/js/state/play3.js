"use strict";
window.mushroom.state.play3 = {
	preload: function(){
		console.log("loading play3 state");
	},
	
	create: function(){
		console.log("starting play3 state");
		

		this.yellowbackground = mt.create("yellowbackground");
		...
		this.number2=mt.create("number3");
	...
	update: function(){
		...
		this.game.physics.arcade.overlap(this.player, this.coins3.self, this.destroyObject, null, this);
