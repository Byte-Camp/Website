"use strict";
window.DiepioSmashersConquest.state.boot = {
	preload: function(){
		// set world size
	...
	create: function(){
		// add all game states
		for(var stateName in window.DiepioSmashersConquest.state){
			this.game.state.add(stateName, window.DiepioSmashersConquest.state[stateName]);
		}
