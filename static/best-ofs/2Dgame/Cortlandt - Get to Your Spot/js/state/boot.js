"use strict";
window.GETBACKTOANTARCTICA.state.boot = {
	preload: function(){
		// set world size
	...
	create: function(){
		// add all game states
		for(var stateName in window.GETBACKTOANTARCTICA.state){
			this.game.state.add(stateName, window.GETBACKTOANTARCTICA.state[stateName]);
		}
