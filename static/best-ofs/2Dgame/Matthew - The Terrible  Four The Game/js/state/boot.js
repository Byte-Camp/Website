"use strict";
window.TheTerribleFourTheVideoGame.state.boot = {
	preload: function(){
		// set world size
	...
	create: function(){
		// add all game states
		for(var stateName in window.TheTerribleFourTheVideoGame.state){
			this.game.state.add(stateName, window.TheTerribleFourTheVideoGame.state[stateName]);
		}
