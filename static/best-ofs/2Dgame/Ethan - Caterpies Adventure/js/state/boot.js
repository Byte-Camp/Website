"use strict";
window.catrpiesadventure.state.boot = {
	preload: function(){
		// set world size
	...
	create: function(){
		// add all game states
		for(var stateName in window.catrpiesadventure.state){
			this.game.state.add(stateName, window.catrpiesadventure.state[stateName]);
		}
