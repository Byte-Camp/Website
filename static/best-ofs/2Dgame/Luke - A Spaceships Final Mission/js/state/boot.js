"use strict";
window.Aspaceshipsfinalmission.state.boot = {
	preload: function(){
		// set world size
	...
	create: function(){
		// add all game states
		for(var stateName in window.Aspaceshipsfinalmission.state){
			this.game.state.add(stateName, window.Aspaceshipsfinalmission.state[stateName]);
		}
